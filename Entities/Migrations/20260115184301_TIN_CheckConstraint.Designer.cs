...
namespace Entities.Migrations
{
    ...
    [Migration("20260115184301_TIN_CheckConstraint")]
    partial class TIN_CheckConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Person", b =>
                {
                    ...
                    b.ToTable("Persons", null, t =>
                        {
                            t.HasCheckConstraint("CHK_Persons_TaxIdentificationNumber", "LEN([TaxIdentificationNumber]) = 8");
                        });
